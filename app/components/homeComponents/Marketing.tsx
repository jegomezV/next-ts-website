...
export const Marketing: React.FC = (): JSX.Element => {
  return (
    <section data-scroll-section>
      <article>
        <div data-scroll className="relative min-h-screen w-[100%] mx-auto flex flex-col justify-center items-center border-y-[1px]">
          <Image
            src={thirdPhoto}
            alt="Background"
            fill
          ...
          <h1 data-scroll data-scroll-speed="0.1" className="
          ...
          <p data-scroll data-scroll-speed="-0.5" className="text-lg text-center text-white mt-4 drop-shadow-[0_1.5px_5px_rgba(0,0,0,0.8)]">
