        ...
        <div className="flex flex-col items-center w-full p-5 max-md:translate-x-1/2 md:items-start md:p-10">
          <div className="grid grid-cols-2 gap-4 mx-auto">
            ...
            <div className="flex items-center justify-center mt-8 md:mt-0 mb-10 md:mb-10">
              <h3 className="text-3xl md:text-4xl font-appleL tracking-[1px] md:tracking-[2px] bg-clip-text text-transparent translate-x-1/2 bg-gradient-to-r from-neutral-500 to-black/90 drop-shadow-[0_1px_3px_rgba(0,0,0,0.8)] text-center">
                {t("credits.tutor")}
              </h3>
            </div>
          </div>
