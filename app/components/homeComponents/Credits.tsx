...
const Credits: React.FC = (): JSX.Element => {
  ...
  return (
    <section id="credits" data-scroll-section className="relative flex flex-col w-screen h-auto min-h-[100vh] mt-20 md:mt-40 effects-section">
      ...
      <div className="text-center translate-y-8 md:translate-y-12 2xl:translate-y-20 absolute w-full bg-black/50 overflow-y-hidden shadow-[0_1px_5px_0px_rgba(0,0,0,1)] border-b-[1px] border-t-[2px] border-white/40">
