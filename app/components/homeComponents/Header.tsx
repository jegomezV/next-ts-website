...
export const HeaderM: React.FC = (): JSX.Element => {
  ...
  2xl:h-[15rem] 2xl:w-[25rem] 2xl:left-[53%] 2xl:bottom-[1rem]
  ...
  xl:h-96 xl:w-[18rem]
  2xl:h-[30rem] 2xl:w-[20rem] 2xl:-left-[1%]
  ...
  2xl:h-[16rem] 2xl:w-[14rem] 2xl:left-8 2xl:bottom-0
  ...
  2xl:h-[12rem] 2xl:w-[9rem] 2xl:left-[25rem] 2xl:top-[55%]
