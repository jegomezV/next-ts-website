    ...
    <section data-scroll-section>
      <article>
        <div className="relative min-h-screen w-[100%] mx-auto flex flex-col justify-center items-center border-t-[1px]">
          ...
          <h1 data-scroll data-scroll-direction='horizontal' data-scroll-speed="-0.2" className="
          ...
          <p data-scroll data-scroll-direction='horizontal' data-scroll-speed="1" className="text-lg text-center text-white drop-shadow-[0_1.5px_5px_rgba(0,0,0,0.8)] mt-4">
