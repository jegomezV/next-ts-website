...
const ModelAlexa: React.FC = (): JSX.Element => {
  return (
    <div data-scroll-section className='max-h-[80%] max-w-[80%] mx-auto my-4 p-4'>
      <div className='text-center'>
        ...
        <p className='text-gray-600'>
          Descripción del modelo Alexa. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
