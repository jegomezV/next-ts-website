      ...
      <div className='flex flex-col gap-8 mx-auto max-w-7xl'>
        <div className='relative flex justify-center'>
          ...
          <div className='text-xl lg:text-2xl p-6 rounded-lg mt-28 text-gray-700 lg:w-[50%] mx-auto font-apple tracking-[2px]'>
            <p>
              {t("actors.diego.biography-fp")}<br /><br />
            </p>
            {showFullText && (
              <>
                <p>
                  {t("actors.diego.biography-sp")}<br /><br />
                </p>
                <p>
                  {t("actors.diego.biography-tp")}<br /><br />
                </p>
                <p>
                  {t("actors.diego.biography-4p")}<br /><br />
                </p>
                <p>
                  {t("actors.diego.biography-5p")}<br /><br />
                </p>
                <p>
                  {t("actors.diego.biography-6p")}<br /><br />
                </p>
                <p>
                  {t("actors.diego.biography-7p")}<br /><br />
                </p>
                <p>
                  {t("actors.diego.biography-8p")}<br /><br />
                </p>
                <p>
                  {t("actors.diego.biography-9p")}<br /><br />
                </p>
                <p>
                  {t("actors.diego.biography-10p")}<br /><br />
                </p>
              </>
            )}
            <button
