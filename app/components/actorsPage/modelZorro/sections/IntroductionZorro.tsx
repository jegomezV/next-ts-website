...
import mainSecondPhoto from '@/public/homeImgs/actorsModals/zorroModal/zorroGallery/mainPhoto.webp';
      ...
      <div className='grid grid-cols-1 gap-8 mx-auto max-w-7xl md:grid-cols-2'>
        <div className='flex flex-col items-center justify-center text-center md:items-start md:text-left'>
          <div className='mt-10 relative h-[300px] w-[300px] md:h-[400px] md:w-[400px] lg:h-[500px] lg:w-[500px]'>
            ...
            >
              ...
              <a href="https://www.instagram.com/zorrogris_zg/" target="_blank" rel="noopener noreferrer" className="flex items-center mt-2 text-2xl text-pink-500 transition transform cursor-pointer hover:text-pink-600 hover:scale-105">
        ...
        <div className='flex flex-col items-center justify-center'>
          ...
          <div className='p-6 mt-6 text-xl lg:text-2xl'>
            ...
            {t("actors.zorroGris.phrase")}
            </p>
            <p className='text-gray-700 font-apple tracking-[2px]'>
              {t("actors.zorroGris.introduction-p")} <br /><br />
            </p>
          </div>
        </div>
      </div>
