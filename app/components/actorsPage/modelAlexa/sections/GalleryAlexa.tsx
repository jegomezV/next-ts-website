...
import rightPhoto from '@/public/homeImgs/actorsModals/alexaModal/AlexaModel2.jpg'
            ...
            <div className='bg-slate-300 z-10 h-full w-full backdrop-blur-lg items-start justify-start drop-shadow-[0_1.5px_5px_rgba(0, 0, 0, 2)]'>
              ...
              <div className='h-[75%] w-[100%] translate-y-20 grid grid-cols-3 items-center justify-center'>
                ...
                <div className='relative h-full w-full'>
                    <Image src={rightPhoto} alt='AlexaBiography' fill objectFit="cover" placeholder="blur" className='drop-shadow-[0_1.5px_20px_rgba(0,0,0,1)] z-50 hover:scale-105 hover:duration-200 duration-200' />
                  </div>
                </div>
