        ...
        <div className='flex flex-col items-center justify-center text-center md:items-start md:text-left'>
          <div className='mt-10 relative h-[300px] w-[300px] md:h-[400px] md:w-[400px] lg:h-[500px] lg:w-[500px]'>
            ...
            >
              ...
              <a href="https://www.instagram.com/jeffry_riascoss/" target="_blank" rel="noopener noreferrer" className="flex items-center mt-2 text-2xl text-pink-500 transition transform cursor-pointer hover:text-pink-600 hover:scale-105">
