  ...
  return (
    <section className='relative h-[42rem] w-full'>
      <div className='absolute h-full w-[100%] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
        <div className='relative flex flex-col border-[3px] border-red-700 items-center justify-start h-[100%] w-[100%] mx-auto my-auto'>
          <div className='top-0 translate-y-5 h-full w-full'>
            <div className='bg-slate-200/40 z-10 border-[3px] h-full w-full border-blue-700 backdrop-blur-lg items-start justify-start drop-shadow-[0_1.5px_5px_rgba(0, 0, 0, 2)]'>
              ...
              <div className='h-[75%] w-[100%] translate-y-20 border-2 border-black grid grid-cols-3 items-center justify-center'>
