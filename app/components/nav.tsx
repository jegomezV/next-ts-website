...
export const Nav: React.FC = () => {
  return (
    <div className='w-[80%] mx-auto'>
      <nav className="fixed top-0 w-[80%] mx-auto py-3 z-10 hover:duration-500 duration-500 hover:shadow-white/30 shadow-inner shadow-white/10 border-y-[1px] wrapper border-white/20 rounded-full mt-3 flex justify-center items-baseline backdrop-blur-3xl">
