...
export const Nav: React.FC = () => {
  return (
    <div className='w-screen mx-auto'>
      <nav className="fixed top-0 w-[100%] mx-auto py-3 lg:py-[14px] z-10 hover:duration-500 duration-500 hover:shadow-white/20 shadow-inner shadow-white/10 border-y-[1px] wrapper border-white/20 mt-3 flex justify-center items-baseline backdrop-blur-3xl">
